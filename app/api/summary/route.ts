    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an expert article analyzer. Provide a brief summary in Russian explaining what the article is about. Be concise and informative. Return only the summary without any additional comments.',
          },
          {
            role: 'user',
            content: `What is this article about? Summarize it in Russian:\n\n${limitedContent}`,
          },
        ],
      }),
    })
